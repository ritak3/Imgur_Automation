...
public class MemberOfSection {
	 ...
	 * @return boolean
	 * @throws Exception
	 * @Description Verifies if the selected section is present in the UI as per
	 *              supplied parameter
	 * @Date Aug 7, 2014
	 */
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Yes/No
	 * @return boolean
	 * @throws Exception
	 * @Description Verifies if the selected field inside the selected section
	 *              is displayed in the UI as per supplied parameter
	 * @Date Aug 7, 2014
	 */
	public boolean IsFieldDisplayed(String FieldName, String YesORNo)
			throws Exception {
	 ...
	 * @Date Aug 7, 2014
	 */
	public String GetViewOnlyValue(String FieldName) throws Exception {
		String Value = "";
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Expected value in the field in View Page
	 * @return boolean
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyViewOnlyValueEquals(String FieldName, String Value)
			throws Exception {
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Expected Value in the field inside a section
	 * @return boolean
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyViewOnlyValueContains(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Expected Value
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyViewOnlyValueStartsWith(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyViewOnlyValueEndsWith(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
		...
		try {
			...
			e.printStackTrace();
			System.out
					.println("Exception:Could not find the element to verify viewonly value when xpath is: "
							+ xpath);
			autoFW.AddToXLLogs(
					"Exception:Could not find the element to verify viewonly value when xpath is: "
							+ xpath, "Fail");
			return false;
		}
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName,Expeceted Value
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyEditFieldValue(String FieldName, String Value)
			throws Exception {
				...
				if (getsingleWebelement.getAttribute("value").trim()
					...
					System.out
							.println("Successfully verified the value for the field ("
									+ FieldName + ")");
					autoFW.AddToXLLogs(
							"Successfully verified the value for the field ("
									+ FieldName + ")", "Pass");
					return true;
				} else {
	 ...
	 * @Date Aug 7, 2014
	 */
	public String GetEditFieldValue(String FieldName) throws Exception {
		String Value = "";
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Checked/Not Checked
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyChkBoxValue(String FieldName,
			String CheckedORNotChecked) throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
				+ FieldName
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Unable to Verify checkbox value for the field("
					+ FieldName + ") when xpath is: " + xpath);
			autoFW.AddToXLLogs("Unable to Verify checkbox value for the field("
					+ FieldName + ") when xpath is: " + xpath, "Fail");
			return false;
		}
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean CheckBoxSelect(String FieldName) throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
				+ FieldName
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean CheckBoxDeSelect(String FieldName) throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
				+ FieldName
		...
		try {
			...
			e.printStackTrace();
			System.out
					.println("Exception:Unable to DeSelect checkbox for the field("
							+ FieldName + ") when xpath is: " + xpath);
			autoFW.AddToXLLogs(
					"Exception:Unable to DeSelect checkbox for the field("
							+ FieldName + ") when xpath is: " + xpath, "Fail");
			return false;
		}
	}
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean PrecedingCheckBoxSelect(String FieldName) throws Exception {
		try {
			if (myWD.findElement(
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean PrecedingCheckBoxDeSelect(String FieldName) throws Exception {
		try {
			if (myWD.findElement(
					By.xpath("//label[contains(normalize-space(text()),'"
							+ FieldName + "')]/preceding-sibling::input[1]"))
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Value to be entered
	 * @return boolean
	 * @throws Exception
	 * @Description Enters the field(text box,text area) value inside a section.
	 * @Date Aug 7, 2014
	 */
	public boolean Type(String FieldName, String Value) throws Exception {
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Value to be selected from picklist/dropdown(Single
	 *        Select List)
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean SelectPL(String FieldName, String Value) throws Exception {
		// Working xpath =
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Unable to select the pick list value(" + Value
					+ ") for the field(" + FieldName + ") when xpath is: "
					+ xpath);
			autoFW.AddToXLLogs("Unable to select the pick list value(" + Value
					+ ") for the field(" + FieldName + ") when xpath is: "
					+ xpath, "Fail");
			return false;
		}
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Type the expected selected/defeult value in the
	 *        picklist field
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyPLValue(String FieldName, String Value)
			throws Exception {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Unable to verify the pick list value(" + Value
					+ ") for the field(" + FieldName + ") when xpath is: "
					+ xpath);
			autoFW.AddToXLLogs("Unable to verify the pick list value(" + Value
					+ ") for the field(" + FieldName + ") when xpath is: "
					+ xpath, "Fail");
			return false;
		}
	 ...
	 * @author Sourav Mukherjee
	 * @DisplayMode Edit Page
	 * @Param FieldName, Semi colon(;) seperated value to be added in the multi
	 *        select pick list field
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean MultiSelectAdd(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
	 ...
	 * @author Sourav Mukherjee
	 * @DisplayMode Edit Page
	 * @Param FieldName, Semi colon(;) seperated value to be removed from the
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean MultiSelectRemove(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
		...
		if (autoFW.WaitForElement(xpath, 1)) {
			...
			autoFW.AddToXLLogs(
					"Successfully removed multiselect pick list values ("
							+ Value + ") for field (" + FieldName + ")", "Pass");
			return true;
		} else {
	 ...
	 * @author Sourav Mukherjee
	 * @DisplayMode Edit Page
	 * @Param FieldName, Semi Colon(;) seperated values expected to be displayed
	 *        in the available list of multi select pick list field inside a
	 *        section
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyMPLAvailable(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
	 ...
	 * @DisplayMode Edit Page
	 * @Param FieldName, Semi Colon(;) seperated values expected to be displayed
	 *        in the chosen list of multi select pick list field inside a
	 *        section
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean VerifyMPLChosen(String FieldName, String Value)
			throws Exception {
		xpath = "//*[text()='"
				+ SectionName
				+ "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
	...
	/**
	 * @author Sourav Mukherjee
	 * @Param FieldName, Value to be selected from SFDC OOB lookup
	 * @DisplayMode Edit page
	 * @return boolean
	 * @throws Exception
	 ...
	 * @Date Aug 7, 2014
	 */
	public boolean SelectFromLookup(String FieldName, String LookUpValue)
			throws Exception {
		 ...
		 * "'][local-name()='h3'][1]/ancestor-or-self::div[1]/following-sibling::div[1]/descendant-or-self::*[contains(text(),'"
		 * +FieldName+
		 * "')][1]/ancestor-or-self::*[local-name()='td' or local-name()='th'][1]/following-sibling::*[local-name()='td' or local-name()='th'][1]/descendant-or-self::span[contains(normalize-space(@class),'lookup')]/input[@type !='hidden'][1]"
