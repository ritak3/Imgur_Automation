...
public class ZAPI {
    ...
    private static final String PROXY_IP = "10.227.73.36";
    ...
    private static final String CREDENTIALS = "mail2souravm:Lab@r3s2";
     ...
     */
    public static List<JSONObject> deleteAttachments(final String executionId) throws Exception {
     ...
     * @throws IOException
     */
    private static JSONArray httpGetJSONArray(final String url) throws Exception {
     ...
     * @throws IOException
     */
    private static JSONObject post(final String url, final JSONObject obj) throws Exception {
	...
	public static void main(String[] args) throws Exception
	{
		...
		//updateTestExecution("9", Status.PASS, "Executed by automation"); //Working
		addAttachment(new File("D:/151215/GLOBALFOUNDRIES/TestLogs/30-12-2015/A091_AccountDisengaged_30-12-2015_11.52.28.081_Pass.xls"),"8"); //Working
